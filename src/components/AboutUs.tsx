...
export default function AboutUs() {
  ...
  return (
    <section id="equipo" className="py-32 bg-gray-50/50 dark:bg-slate-900/50 border-y border-gray-100 dark:border-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
            className="mb-4 inline-block bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-sm rounded-full px-5 py-1.5"
          >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {team.map((member, index) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative p-8 md:p-10 rounded-[2.5rem] bg-white dark:bg-slate-900 hover:bg-[#fcfdff] dark:hover:bg-slate-800/50 border border-gray-100 dark:border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/20 transition-all duration-500 flex flex-col items-center md:items-start overflow-hidden"
            >
              {/* Card Hover Glow */}
              ...
              {/* Avatar Container */}
              <div className="w-40 h-40 md:w-44 md:h-44 mb-8 relative rounded-full overflow-hidden shadow-xl shadow-gray-200/60 transition-all duration-500 mx-auto md:mx-0 bg-gradient-to-b from-blue-50/80 to-blue-100/30 dark:from-slate-800 dark:to-slate-700 border-4 border-white dark:border-slate-800 flex items-end justify-center group-hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-primary/20 z-10">
                <img
                  src={member.image}
              ...
              <div className="text-center md:text-left z-10 w-full flex-grow flex flex-col">
                <h3 className="text-3xl font-black text-gray-900 dark:text-white mb-2 mt-2">{member.name}</h3>
                ...
                <div className="w-full flex justify-center md:justify-start mb-8">
                  <div className="w-16 h-1.5 bg-gray-100 dark:bg-slate-700 group-hover:bg-primary/20 rounded-full transition-colors duration-300 relative overflow-hidden">
                ...
                <ul className="mb-10 space-y-4 w-full">
                  {member.points.map((point, i) => (
                    <li key={i} className="flex items-start text-left gap-3 text-gray-600 dark:text-slate-400 group-hover:text-gray-800 dark:group-hover:text-slate-200 transition-colors duration-300">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-50 dark:bg-slate-800 flex items-center justify-center mt-0.5 group-hover:bg-primary/10 transition-colors">
                ...
                <div className="mt-auto pt-4 relative z-10 w-full">
                  <a
                    ...
                    className="flex w-full items-center justify-center gap-3 px-6 py-4 rounded-2xl font-bold text-gray-600 dark:text-slate-300 bg-gray-50 dark:bg-slate-800 border border-gray-100 dark:border-slate-700 hover:text-white hover:bg-[#24292e] dark:hover:bg-[#1a1e23] hover:border-[#24292e] dark:hover:border-transparent transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/20 group/btn"
                  >
